          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-wrap items-end gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="recoverability-startDate" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-1">Start Date</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="recoverability-endDate" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-1">End Date</Label>
                <Input
            ...
            <div className="space-y-2">
              ...
              <div 
                onClick={() => document.getElementById('recoverability-file-input')?.click()}
              ...
              >
                ...
                {file ? (
                  ...
                  <>
                    ...
                    <div className="text-center">
                      <p className="text-sm font-bold text-slate-700">Click to select Recoverability CSV file</p>
              ...
              <p className="text-[10px] text-slate-400 leading-relaxed mt-2">
                Required columns: Client Group(s), Staff, Client, Account Manager, Job Manager, Date, Time, Billable Rate, Billable Amount, Invoiced Amount, Write On Amount
              </p>
            </div>
