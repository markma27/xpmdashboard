...
export function RecoverabilityClientGroupsTable({ 
  ...
  if (error) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Recoverability by Client Group</CardTitle>
          <CardDescription>Detailed recoverability breakdown by client group</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {sortedData.map((item, index) => {
                ...
                return (
                  <tr key={index} className="border-b hover:bg-muted/50">
                    ...
                    <td className={`p-3 text-right font-medium ${item.currentYear < 0 ? 'text-red-600' : ''}`}>
              ...
              <tr className="border-t-2 font-semibold bg-muted/30">
                ...
                <td className="p-3"></td>
                <td className="p-3"></td>
                <td className={`p-3 text-right ${totalCurrentYear < 0 ? 'text-red-600' : ''}`}>
