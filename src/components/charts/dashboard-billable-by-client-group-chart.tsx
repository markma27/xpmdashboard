...
interface DashboardBillableByClientGroupChartProps {
  data: ClientGroupBillableData[]
  loading?: boolean
}

export function DashboardBillableByClientGroupChart({ data, loading }: DashboardBillableByClientGroupChartProps) {
