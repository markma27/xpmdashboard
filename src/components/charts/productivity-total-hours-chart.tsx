...
interface ProductivityTotalHoursChartProps {
  data: MonthlyTotalHoursData[]
}

export function ProductivityTotalHoursChart({ data }: ProductivityTotalHoursChartProps) {
      ...
      <div className="rounded-lg border bg-background p-3 shadow-md">
        <div className="text-sm font-medium flex items-center gap-2">
          <div 
            ...
            style={{ backgroundColor: currentYearPayload?.color || '#3b82f6' }}
          />
          <span>
